...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/29 12:52:25 by vmoroka           #+#    #+#             */
/*   Updated: 2025/11/29 12:52:27 by vmoroka          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_token_node	*init_new_token_node(int *errno)
{
	...
	new_tkn = malloc(sizeof(t_token_node));
	if (!new_tkn)
	{
		*errno = 1;
		return (NULL);
...
static void	process_split_node(t_token_node *cur, t_token_node *new_tkn,
		int space_index, int *errno)
{
	char	*temp;
